        ...
        <form action="RoyschedController" method="post">
            ...
            <table>
                ...
                <tr>
                    <td>Lorange</td>
                    <td>
                        <input type="number" name="Lorange" value="<%=rsTitle.getString(2)%>">
                    </td>
                </tr>
                <tr>
                    <td>Hirange</td>
                    <td>
                        <input type="number" name="Hirange" value="<%=rsTitle.getString(3)%>">
                    </td>
                </tr>
                <tr>
                    <td>Royalty</td>
                    <td>
                        <input type="number" name="Royalty" value="<%=rsTitle.getString(4)%>">
                    </td>
                </tr>
            </table>
            <p>
