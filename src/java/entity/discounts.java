...
public class discounts {
    ...
    public String toString() {
        return "discounts{" + "discounttype=" + discounttype + ", stor_id=" + stor_id + ", lowqty=" + lowqty + ", highqty=" + highqty + ", discount=" + discount + '}';
    }

    public discounts(String discounttype, String stor_id, int lowqty, int highqty, double discount) {
