 ...
 * @author pallgree
 */
@WebServlet(urlPatterns = {"/shopPagination"})
public class shopPagination extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int num_offset=Integer.parseInt(num);
        DAOtiltes dao=new DAOtiltes();
        Vector<tiltes> list= dao.view5Tiles(num_offset);
