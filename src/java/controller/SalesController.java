    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("insertSales")) {
             ...
             if (service.equals("deleteSales")) {
                String stor_id = request.getParameter("storID");
                dao.deleteSales(stor_id);
                response.sendRedirect("SalesController");
            }
            ...
            if (service.equals("listAllSales")) {
                ...
                // select jsp
                RequestDispatcher dispath = request.getRequestDispatcher("template/admin/sales.jsp");
                dispath.forward(request, response);
            }
            
            if (service.equals("search")) {
                String name=request.getParameter("query");
                Vector<sales> vector = dao.searchStoID(name);
                request.setAttribute("list", vector);          
                // select jsp
                RequestDispatcher dispath = request.getRequestDispatcher("template/admin/sales.jsp");
                dispath.forward(request, response);
